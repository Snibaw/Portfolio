...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        'service_7ytqi17', // paste your ServiceID here (you'll get one when your service is created).
        'template_v8oy2gp', // paste your TemplateID here (you'll find it under email templates).
        {
          from_name: form.name,
